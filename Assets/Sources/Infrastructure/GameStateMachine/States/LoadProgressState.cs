...
namespace Assets.Sources.Infrastructure.GameStateMachine.States
{
    public class LoadProgressState : IState
    {
        ...
        private PlayerProgress CreateNewProgress()
        {
            ...
            PlayerCharacterData[] characterSkinDatas = _staticDataService.PlayerCharacterCofigs.Select(config => new PlayerCharacterData(config.Id, config.IsUnlockedOnStart)).ToArray();
